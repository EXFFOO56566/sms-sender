<form method="post" action="<?=base_url()?>smsender/groups/update/<?=$item->id?>" class="modal-wrapper column-4" validate-form="true" validation-error="<?=$this->lang->line("please_check_marked_fields")?>">
	...
	<div class="modal-content">
		...
		<?php
		$this->event->register("SMSenderGroupUpdateFormRow",$item);
		?>		
